...
fout = open('../../RelatoriosMI/'+mes+'.txt', 'w')
...
for orgao in a:
    ...
    soma = 0
    for nome in nomes:
        fout.write(' ' + '{:2}'.format(orgaos[orgao][nome]) + ': ' + nome.encode('utf8') + ' - ' + end[nome].encode('utf8') +'\n')
